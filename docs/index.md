...
![A diagram of a basic website structure using semantic HTML elements](/sh-exemple-light.svg#no-shadow#light)
![A diagram of a basic website structure using semantic HTML elements](/sh-exemple-dark.svg#no-shadow#dark)
